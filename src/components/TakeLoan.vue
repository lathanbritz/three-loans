    ...
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
            ...
            <p v-if="qr_link==null" class="col-md-8 fs-4">
                ...
                <p><a class="btn btn-dark text-white" @click="returnHome" role="button" id="return">Return</a><a class="btn btn-purple text-white ms-2" @click="createLoan" role="button" id="login">Create Loan</a></p>
            </p>
